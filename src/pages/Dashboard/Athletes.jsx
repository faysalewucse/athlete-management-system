...
export const Athletes = () => {
  ...
  const { isLoading, data: athletes = [] } = useQuery({
                    ...
                    >
                      ...
                      <td>
                        <div className="flex text-sm items-center space-x-4 justify-center">
                          <h1 className="bg-secondary hover:bg-secondary2 transition-300 text-white hite py-1 px-4 rounded cursor-pointer">
                            Assign to a team
                          </h1>
                          <h1 className="bg-primary hover:bg-primary2 transition-300 text-white hite py-1 px-4 rounded cursor-pointer">
                            Change Role
                          </h1>
                          <h1 className="bg-success hover:bg-success2 transition-300 text-white hite py-1 px-4 rounded cursor-pointer">
                            Edit
                          </h1>
                          <h1 className="bg-danger hover:bg-danger2 transition-300 text-white hite py-1 px-4 rounded cursor-pointer">
                            Delete
                          </h1>
