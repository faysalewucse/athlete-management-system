    ...
    <div>
      {currentUser?.role !== "athlete" ? (
        ...
        >
          ...
          <div className=" grid grid-cols-1 md:grid-cols-2 items-start md:ml-36">
            <div className="flex flex-col justify-center">
              <h1 className="text-lg font-semibold text-gradient">
                Additional Info
              </h1>
              <div>
                <Form.Item name="sports" label="Sports" className="w-1/2 mt-2">
                  <Input placeholder="The sports you are involved" />
                </Form.Item>
                <Form.Item name="position" label="Position" className="w-1/2">
            ...
            <div>
              ...
              <Form.Item name="endurance" label="Endurance" className="w-1/2">
                <Input
                  type="number"
